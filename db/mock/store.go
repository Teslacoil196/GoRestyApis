...
// Source: TeslaCoil196/db/sqlc (interfaces: Store)
//
...
// ListTransfersFromAccountToAccount mocks base method.
func (m *MockStore) ListTransfersFromAccountToAccount(ctx context.Context, arg db.ListTransfersFromAccountToAccountParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTransfersFromAccountToAccount", ctx, arg)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListTransfersFromAccountToAccount indicates an expected call of ListTransfersFromAccountToAccount.
func (mr *MockStoreMockRecorder) ListTransfersFromAccountToAccount(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTransfersFromAccountToAccount", reflect.TypeOf((*MockStore)(nil).ListTransfersFromAccountToAccount), ctx, arg)
}
...
func (m *MockStore) TranferTx(ctx context.Context, arg db.TransferTxParams) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TranferTx", ctx, arg)
...
func (mr *MockStoreMockRecorder) TranferTx(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TranferTx", reflect.TypeOf((*MockStore)(nil).TranferTx), ctx, arg)
}
