...
select id, from_account_id, to_account_id, amount, created_at from transfers where from_account_id = $1 order by created_at desc limit $2 offset $3
`
...
select id, from_account_id, to_account_id, amount, created_at from transfers where from_account_id = $1 and to_account_id = $2 order by created_at desc limit $3 offset $4
`
...
select id, from_account_id, to_account_id, amount, created_at from transfers where to_account_id = $1 order by created_at desc limit $2 offset $3
`
